<template>
    <div>
      <!-- Your Vue.js template code here -->
  
      <!-- Form containing Razorpay payment button script -->
      <form ref="razorpayForm">
        <!-- Content inside the form, if needed -->
      </form>
    </div>
  </template>
  ...
  export default {
    mounted() {
      ...
      script.async = true;
      script.dataset.payment_button_id = "pl_N5qMUf1JdSwAgG";
